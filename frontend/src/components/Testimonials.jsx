...
export const Testimonials = () => (
  <section id="testimonials" data-testid="testimonials-section" className="relative py-24 sm:py-32 bg-[#050505]">
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
        <span className="text-[#FF0033] text-xs font-bold tracking-[0.3em] uppercase">Success Stories</span>
        <h2 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-white mt-4">
          Students Who Made It <span className="text-[#FF0033]">Big</span>
        </h2>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
        {TESTIMONIALS.map((t, i) => (
          <motion.div
            ...
            className="rounded-3xl p-7 bg-gradient-to-br from-red-950/30 to-black/80 backdrop-blur-2xl border border-[#FF0033]/20 hover:border-[#FF0033]/60 hover:-translate-y-2 transition-all duration-300 flex flex-col"
          >
            <Quote className="text-[#FF0033]/60" size={26} />
            <p className="text-white/70 text-sm leading-relaxed mt-4 flex-1">"{t.text}"</p>
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[#FF6680] text-xs">{t.course}</div>
                </div>
              </div>
            </div>
          </motion.div>
