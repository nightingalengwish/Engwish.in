...
export const About = () => (
  <section id="about" data-testid="about-section" className="relative py-24 sm:py-32 overflow-hidden">
    <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 70% 60% at 20% 50%, rgba(255,0,51,0.06), #ffffff 70%)" }} />
    <div className="relative max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
      <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        <span className="text-[#E60023] text-xs font-bold tracking-[0.3em] uppercase">About Engwish</span>
        <h2 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-neutral-900 mt-4">
          Where Skills Meet <span className="text-[#E60023]">Ambition</span>
        </h2>
      ...
      <div className="grid grid-cols-2 gap-6">
        {STATS.map((s, i) => (
          <motion.div
            ...
            className="rounded-3xl p-8 bg-white border border-[#FF0033]/15 shadow-[0_4px_25px_rgba(0,0,0,0.05)] hover:border-[#FF0033]/50 hover:shadow-[0_10px_35px_rgba(255,0,51,0.12)] hover:-translate-y-1 transition-all duration-300 text-center"
          >
            <s.icon className="text-[#E60023] mx-auto" size={26} />
            <div className="font-heading text-3xl font-bold text-neutral-900 mt-3">{s.value}</div>
